...
class Encoder_overall(Module):
    ...
    def __init__(self, dim_in_feat_omics1, dim_out_feat_omics1, dim_in_feat_omics2, dim_out_feat_omics2, dim_in_feat_omics3, dim_out_feat_omics3, dropout=0.0, act=F.relu):
        ...
        self.atten_cross = AttentionLayer_triplet(self.dim_out_feat_omics1, self.dim_out_feat_omics2)
    ...
    def forward(self, features_omics1, features_omics2, features_omics3, adj_spatial_omics1, adj_feature_omics1, adj_spatial_omics2, adj_feature_omics2, adj_spatial_omics3, adj_feature_omics3):
        ...
        emb_latent_omics1_omics2_across_recon = self.encoder_omics2(self.decoder_omics2(emb_latent_omics1, adj_spatial_omics2), adj_spatial_omics2) 
        emb_latent_omics1_omics3_across_recon = self.encoder_omics3(self.decoder_omics3(emb_latent_omics1, adj_spatial_omics3), adj_spatial_omics3)
        
        emb_latent_omics2_omics1_across_recon = self.encoder_omics1(self.decoder_omics1(emb_latent_omics2, adj_spatial_omics1), adj_spatial_omics1)
        emb_latent_omics2_omics3_across_recon = self.encoder_omics3(self.decoder_omics3(emb_latent_omics2, adj_spatial_omics3), adj_spatial_omics3)
        
        emb_latent_omics3_omics1_across_recon = self.encoder_omics1(self.decoder_omics1(emb_latent_omics3, adj_spatial_omics1), adj_spatial_omics1)
        emb_latent_omics3_omics2_across_recon = self.encoder_omics2(self.decoder_omics2(emb_latent_omics3, adj_spatial_omics2), adj_spatial_omics2)
...
class AttentionLayer_triplet(Module):
