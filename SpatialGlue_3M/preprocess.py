...
def construct_neighbor_graph(adata_omics1, adata_omics2, adata_omics3, n_neighbors=3): 
    ...
    ################# feature graph #################
    feature_graph_omics1, feature_graph_omics2, feature_graph_omics3 = construct_graph_by_feature(adata_omics1, adata_omics2, adata_omics3)
    adata_omics1.obsm['adj_feature'], adata_omics2.obsm['adj_feature'], adata_omics3.obsm['adj_feature'] = feature_graph_omics1, feature_graph_omics2, feature_graph_omics3
...
def construct_graph_by_feature(adata_omics1, adata_omics2, adata_omics3, k=20, mode= "connectivity", metric="correlation", include_self=False):
    ...
    feature_graph_omics3=kneighbors_graph(adata_omics3.obsm['feat'], k, mode=mode, metric=metric, include_self=include_self)
